    ...
    return (
        <>
            <main className='grid gap-1 grid-cols-3 auto-rows-max mt-[16px] px-[16px]'>
                <div className='cursor-pointer flex flex-col w-[117px] h-[122px] bg-[#FFFFFF] border-[1px] border-solid border-[#B8B8B8] rounded-lg'>
                    ...
                    <div className='w-full bg-[#B8B8B8] rounded-b-lg'>
